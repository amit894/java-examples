...
public class subArraySumEqualsK {
    ...
    public static void main (String args []){
        ...
        System.out.println(SumEqualK1(C,6));
        System.out.println(SumEqualK1(C,7));
        ...
        System.out.println(SumEqualK(B,3));
        System.out.println(SumEqualK(C,6));
        System.out.println(SumEqualK(C,7));
